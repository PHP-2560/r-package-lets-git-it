...
pay.per.year(100, .07, years=17)


#the loan amount each year over the years 
payments(base, interest, payment) #need to then concatanate the growing loan as a vector over the residency years together with this, should end with zero debt at 20 years
