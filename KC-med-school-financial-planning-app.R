...
#Word form output is put below here (explaining the results in a paragraph for each option)  
  ...
  HTML(
    paste0("Using the ", "<b>", "standard repayment plan ", "</b>",
           ...
           disposable_standard[2],
           " per year during residency, and $",
           disposable_standard[9],
           ...
           cum_disposable_standard[20], ".", '<br/>',
           '<br/>', "Using the ", "<b>", "10-year repayment plan ", "</b>",
           "(in which you must work at a 401(c) and then must pay back the entirety of your private loans and pay 10% of your salary for 10 years),
           you will pay $", total_paid_ten[20],
           " in total. This will work out to an average of $", payment_ten[1],
           " per year during residency, $", payment_ten[9],
           " during attendinghood, and", payment_ten[19],
           " after completing your 10-years of repayments. After taxes this means you will make an average of $",
           disposable_ten[2], " per year during residency, $",
           disposable_ten[9], " per year during attendinghood, and $",
           disposable_ten[19],
           ...
           total_paid_twenty[20], " in total. This will work out to an average of $",
           payment_twenty[1], " per year during residency and $",
           payment_twenty[19], " during attendinghood. After taxes this means you will make an average of $",
           disposable_twenty[2], " per year during residency and $",
           disposable_twenty[19], " per year during attendinghood (these values are your salary after removing taxes and debt payments). In your first 20 years after med school, after taxes and debt repayments, you will make a total of $",
           cum_disposable_twenty[20], ".", '<br/>',
           ...
           total_paid_underserved[20], " in total. This will work out to an average of $",
           underserved.payment[1], " per year during residency and $",
           underserved.payment[9], " during attendinghood. After taxes this means you will make an average of $",
           disposable_underserved[2], " per year during residency and $",
           disposable_underserved[19], " per year during attendinghood (these values are your salary after removing taxes and debt payments). In your first 20 years after med school, after taxes and debt repayments, you will make a total of $",
           cum_disposable_underserved[20], ".", '<br/>',
           '<br/>', "If you ", "<b>", "join the military", "</b>",
           ", they will pay for your medical education. This means we removed all of your medical loans on presenting this option. Note that committing to the military comes with a complex comitment including a different match process and 4-6 years of military service owed after your residency (you either owe 4 years or the number of years of residency-1 year, whichever is larger). You will still have to pay off your undergrad loans however. This means you will pay $",
           total_paid_military[20], " in total. This will work out to an average of $",
           military.payment[1], " per year during residency and $", 
           military.payment[19],
           ...
           disposable_military[5], " during each year in the military and $",
           disposable_military[19], " per year during attendinghood (these values are your salary after removing taxes and debt payments). In your first 20 years after med school, after taxes and debt repayments, you will make a total of $",
           cum_disposable_military[20], "."
    )
  )
